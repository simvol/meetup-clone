...
var _envConfig = __webpack_require__(140);
    ...
    switch (action.type) {
        case 'TOGGLE_WEEK_DAY':
            return _extends({}, state, {
                weekDays: state.weekDays.map(function (day) {
                    if (day.value === action.payload.value) day.active = !day.active;
                    return day;
                })
            });
...
var Provider = exports.Provider = function (_Component) {
    ...
    function Provider() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Provider.__proto__ || Object.getPrototypeOf(Provider)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            filteredEvents: [],
            inputFilter: '',
            weekDays: [{ label: 'Monday', value: 0, active: true }, { label: 'Tuesday', value: 1, active: true }, { label: 'Wednesday', value: 2, active: true }, { label: 'Thursday', value: 3, active: true }, { label: 'Friday', value: 4, active: true }, { label: 'Saturday', value: 5, active: true }, { label: 'Sunday', value: 6, active: true }],
            eventsMode: _main.EVENTS_CARDS_VIEW_MODE,
    ...
    _createClass(Provider, [{
        ...
        value: function getEventDetails() {
            ...
            var getContactDetails = _envConfig.IS_PRODUCTION ? _envConfig.URL + '/.../...?access_token=' + this.state.accessToken : _envConfig.URL + '/event.json';

            fetch(getContactDetails).then(function (res) {
                return res.json();
            }).then(function (data) {
                _this2.state.dispatch({ type: 'EVENT_DETAILS_LOADED', payload: data });
            }).catch(function (err) {
        ...
        value: function getEvents() {
            ...
            var getContactsUrl = _envConfig.IS_PRODUCTION ? _envConfig.URL + '/find/upcoming_events?access_token=' + this.state.accessToken : _envConfig.URL + '/events.json';

            fetch(getContactsUrl).then(function (res) {
                return res.json();
            }).then(function (data) {
                _this3.state.dispatch({ type: 'EVENTS_LOADED', payload: data.events });
            }).catch(function (err) {
                return console.log(err);
            });
        }
        ...
        value: function componentDidMount() {
            ...
            var needToGetTokenFromUrl = _envConfig.IS_PRODUCTION && (!this.state.accessToken || this.state.accessToken === 'null') && location.href.indexOf('access_token') !== -1;

            var needToRedirectToGetToken = _envConfig.IS_PRODUCTION && (!this.state.accessToken || this.state.accessToken === 'null');

            if (needToGetTokenFromUrl) {

                var query = location.href.slice(location.href.indexOf('#') + 1).split('&');
                ...
                this.setState({
                    ...
                    window.localStorage.setItem('access_token', _this4.state.accessToken);
                    window.localStorage.setItem('token_type', _this4.state.tokenType);
                    window.localStorage.setItem('token_expires_in', _this4.state.tokenExpiresIn);
                });
            } else if (needToRedirectToGetToken) {
                location.href = _envConfig.GET_TOKEN_URL;
            } else {
                this.getEvents();
...
var EVENTS_PANELS_VIEW_MODE = exports.EVENTS_PANELS_VIEW_MODE = 'panels';
var EVENTS_CARDS_VIEW_MODE = exports.EVENTS_CARDS_VIEW_MODE = 'cards';
var EVENTS_MAP_VIEW_MODE = exports.EVENTS_MAP_VIEW_MODE = 'map';
...
var getWithoutTags = exports.getWithoutTags = function getWithoutTags(html) {
    return html.replace(/<p>|<\/p>/g, '');
};

var getShorterThan = exports.getShorterThan = function getShorterThan(text, limit) {
    return text && text.length > limit ? text.slice(0, limit) + '...' : text;
};

var getFilteredEvents = exports.getFilteredEvents = function getFilteredEvents(state) {
    ...
    .filter(function (event) {
        return event.name.toLowerCase().indexOf(inputFilter.toLowerCase()) !== -1 || event.group.name.toLowerCase().indexOf(inputFilter.toLowerCase()) !== -1;

        // Filter by day of week
    }).filter(function (event) {
        var eventDay = new Date(event.local_date).getDay();
        return weekDays.filter(function (wDay) {
            return wDay.active;
        }).filter(function (wDay) {
            return wDay.value === eventDay;
        }).length > 0;
    });
};
...
var IS_PRODUCTION = exports.IS_PRODUCTION = "production" === 'production';
var API_KEY = exports.API_KEY = IS_PRODUCTION ? '' : '6e6b241475753646385b711b167438';
var URL = exports.URL = IS_PRODUCTION ? 'https://api.meetup.com' : 'http://localhost:8080/data';
var CONSUMER_API_KEY = exports.CONSUMER_API_KEY = 't6nhr8b8mk2r4fjfg82ffgh44c';
var REDIRECT_URL = exports.REDIRECT_URL = 'https://simvol.github.io/meetup-clone/';
var GET_TOKEN_URL = exports.GET_TOKEN_URL = 'https://secure.meetup.com/oauth2/authorize?client_id=' + CONSUMER_API_KEY + '&response_type=token&redirect_uri=' + REDIRECT_URL;
var G_API_KEY = exports.G_API_KEY = 'AIzaSyBorQkgbp6QMWBiDWCEy864kk3qgihg-rA';
...
*/
var aa=__webpack_require__(12),ba=__webpack_require__(2),m=__webpack_require__(146),p=__webpack_require__(11),v=__webpack_require__(14),da=__webpack_require__(147),ea=__webpack_require__(148),fa=__webpack_require__(149),ha=__webpack_require__(13);
...
var _EventDetails = __webpack_require__(177);
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(_reactRouterDom.Route, { path: '/meetup-clone/event', component: _EventDetails2.default })
                            )
                        )
                    )
                )
...
var _EventsMap = __webpack_require__(170);

var _EventsMap2 = _interopRequireDefault(_EventsMap);

var _WeekDaysFilter = __webpack_require__(174);

var _WeekDaysFilter2 = _interopRequireDefault(_WeekDaysFilter);
...
var EventsView = function EventsView(props) {
    var view = props.view,
        events = props.events,
        classes = props.classes;


    if (view === _main.EVENTS_MAP_VIEW_MODE) {
        return _react2.default.createElement(_EventsMap2.default, { events: events });
    } else {
        return _react2.default.createElement(
            'div',
            { className: classes },
    ...
    _createClass(Events, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                null,
                function (value) {
                    var events = (0, _helpers.getFilteredEvents)(value);
                    var view = value.eventsMode;
                    var classes = 'm-2 ' + (view ? 'view-' + view : '');

                    return _react2.default.createElement(
                        'div',
                        { className: 'offset-1 col-10' },
                        _react2.default.createElement(_WeekDaysFilter2.default, null),
                        _react2.default.createElement(EventsView, {
                            classes: classes,
                            view: view,
                            events: events })
                    );
...
var _reactMoment = __webpack_require__(15);
...
var Event = function (_Component) {
    ...
    _createClass(Event, [{
        key: 'getRibbonColor',
        value: function getRibbonColor(limit, rsvped) {
            var fullPercentage = rsvped / limit * 100;
        ...
        value: function render() {
            ...
            var _props$event = this.props.event,
                time = _props$event.time,
                local_date = _props$event.local_date,
                name = _props$event.name,
                group = _props$event.group,
                description = _props$event.description,
                rsvp_limit = _props$event.rsvp_limit,
                yes_rsvp_count = _props$event.yes_rsvp_count;

            var desc = (0, _helpers.getShorterThan)((0, _helpers.getWithoutTags)(description), DESC_LENGTH - name.length - group.name.length);
            var eventDay = new Date(local_date).getDay();
            ...
            return _react2.default.createElement(
                ...
                function (value) {
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement('div', { className: ribbonClasses }),
                        _react2.default.createElement(
                            'div',
                            { className: eventTimeClasses },
                            _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: eventInfoClasses },
                            _react2.default.createElement(
                                'span',
                                { className: 'event-info-name' },
                                name
                            ),
                            _react2.default.createElement('div', { className: 'event-info-separator' }),
                            _react2.default.createElement(
                                'span',
                                { className: 'event-info-group' },
                                group.name
                            )
                        ),
                        _react2.default.createElement(
                            'div',
                            { className: eventDescClasses },
                            _react2.default.createElement(
                                'p',
                                null,
                                desc
...
// module
exports.push([module.i, ".event-time {\n  color: #9c9c9c; }\n\n.event-info-name {\n  font-size: 20px;\n  display: block;\n  color: #333; }\n\n.event-info-group {\n  color: #616161; }\n\n.view-cards .event-container {\n  width: 300px;\n  height: 360px;\n  position: relative; }\n  .view-cards .event-container .event-info {\n    margin-top: 40px; }\n  .view-cards .event-container .event-info-separator {\n    border: 1px solid #bbb;\n    width: 30px;\n    margin: 5px 0; }\n  .view-cards .event-container .event-desc {\n    margin-top: 40px; }\n\n.event-container .ribbon {\n  position: absolute;\n  top: 0;\n  z-index: 0;\n  right: 30px;\n  width: 50px;\n  height: 72px; }\n  .event-container .ribbon.event-full {\n    background: url(" + escape(__webpack_require__(162)) + ") #f44336;\n    background-size: 80%;\n    background-position: 50% 20%; }\n  .event-container .ribbon.event-nearly-full {\n    background: url(" + escape(__webpack_require__(163)) + ") #e91e63;\n    background-size: 70%;\n    background-position: 50% 25%; }\n  .event-container .ribbon.event-half-full {\n    background: url(" + escape(__webpack_require__(164)) + ") #3f51b6;\n    background-size: 60%;\n    background-position: 50% 30%; }\n  .event-container .ribbon.event-getting-full {\n    background: url(" + escape(__webpack_require__(165)) + ") #2196f3;\n    background-size: 50%;\n    background-position: 50% 30%; }\n  .event-container .ribbon.event-fresh {\n    background: url(" + escape(__webpack_require__(166)) + ") #8bc34a;\n    background-size: 40%;\n    background-position: 50% 30%; }\n  .event-container .ribbon.event-full, .event-container .ribbon.event-nearly-full, .event-container .ribbon.event-half-full, .event-container .ribbon.event-getting-full, .event-container .ribbon.event-fresh {\n    background-repeat: no-repeat; }\n  .event-container .ribbon img, .event-container .ribbon span {\n    width: 50%;\n    position: absolute;\n    left: 50%;\n    top: 40%;\n    transform: translate3d(-50%, -60%, 0); }\n  .event-container .ribbon span {\n    font-size: 20px;\n    color: #ffffff; }\n  .event-container .ribbon img {\n    width: 50%; }\n  .event-container .ribbon:after {\n    content: '';\n    position: absolute;\n    bottom: 0;\n    width: 0;\n    height: 0;\n    border-style: solid;\n    border-width: 0 25px 24px 25px;\n    border-color: transparent transparent #ffffff transparent; }\n\n.view-panels .ribbon {\n  display: none; }\n", ""]);
...
module.exports = __webpack_require__.p + "ebc0865a99c3e55b0a39744c64e252c4.svg";

/***/ }),
/* 163 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "d2ebe7821f2eeb0b6bd271c1334d1eef.svg";

/***/ }),
/* 164 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "e1e71b8a3dc29fffe30c770b37cd7b7c.svg";

/***/ }),
/* 165 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "91b32f2d801a9485cb0a563b67b2ae4c.svg";

/***/ }),
/* 166 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "63cfd5a7f3d54176d488c62487ef7c6c.svg";
...
var $script = __webpack_require__(173);

var loadMapApi = function loadMapApi(initMapCallback) {
    $script('https://maps.googleapis.com/maps/api/js?key=' + _envConfig.G_API_KEY, function () {
        return initMapCallback();
    });
};

var EventsMap = function (_Component) {
    _inherits(EventsMap, _Component);
    ...
    function EventsMap() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = EventsMap.__proto__ || Object.getPrototypeOf(EventsMap)).call.apply(_ref, [this].concat(args))), _this), _this.initMap = function () {
            var vancouver = { lat: 49.2578262, lng: -123.0241152 };
    ...
    _createClass(EventsMap, [{
        key: 'componentDidMount',
        value: function componentDidMount() {
            loadMapApi(this.initMap);
        }
    }, {
        key: 'render',
        value: function render() {
            return _react2.default.createElement('div', { className: 'mt-3', id: 'map' });
        }
    }]);
...
var WeekDayFilter = function (_Component) {
    _inherits(WeekDayFilter, _Component);
    ...
    function WeekDayFilter() {
        ...
        _classCallCheck(this, WeekDayFilter);

        for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        }

        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = WeekDayFilter.__proto__ || Object.getPrototypeOf(WeekDayFilter)).call.apply(_ref, [this].concat(args))), _this), _this.toggleDay = function (dispatch, day) {
            dispatch({ type: 'TOGGLE_WEEK_DAY', payload: day });
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }

    _createClass(WeekDayFilter, [{
        key: 'render',
        value: function render() {
            var _this2 = this;
                ...
                function (value) {
                    ...
                    return _react2.default.createElement(
                        ...
                        weekDays.map(function (day) {
                            var classes = 'mx-3 clickable badge badge-' + (day.active ? 'primary' : 'light');

                            return _react2.default.createElement(
                                'div',
                                { className: classes, key: day.value, onClick: _this2.toggleDay.bind(_this2, dispatch, day) },
                                day.label
                            );
                        })
                    );
...
// module
exports.push([module.i, ".view-cards {\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center; }\n", ""]);
            ...
            return _react2.default.createElement(
                ...
                function (value) {
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            'div',
                            { className: 'main row shadow-sm border bg-white py-3 ' },
                            _react2.default.createElement(
                                'div',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { className: 'hosted-by' },
                                    _react2.default.createElement('img', { className: 'img-round' }),
                                    _react2.default.createElement(
                                        'span',
                                        null,
                                        'Hosted by '
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'div',
                                    { 'class': 'py-3 text-center border rounded' },
                                    '29 people going'
                                )
                            )
                        ),
...
var Header = function (_Component) {
    ...
    function Header() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Header.__proto__ || Object.getPrototypeOf(Header)).call.apply(_ref, [this].concat(args))), _this), _this.filterChanged = function (dispatch, e) {
            dispatch({ type: 'FILTER_CHANGED', payload: e.target.value });
        }, _this.changeMode = function (dispatch, mode) {
    ...
    _createClass(Header, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                null,
                function (value) {
                    var inputFilter = value.inputFilter,
                        dispatch = value.dispatch;
                    ...
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement('img', { src: _logo2.default, width: '30', height: '30', className: 'd-inline-block align-top mx-2', alt: 'Meetup logo' }),
                            'Meetup'
                        ),
                        _react2.default.createElement(
                            'div',
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '#', onClick: _this2.changeMode.bind(_this2, dispatch, _main.EVENTS_MAP_VIEW_MODE) },
                                'Map'
                            ),
                            _react2.default.createElement(
                                'div',
                                ...
                                _react2.default.createElement('input', { type: 'text',
                                    ...
                                    placeholder: 'Search...',
                                    onChange: _this2.filterChanged.bind(_this2, dispatch),
                                    value: inputFilter })
                            )
                        )
                    );
...
module.exports = __webpack_require__.p + "598ebeea0e66134a7e6eb71e29f25773.svg";
